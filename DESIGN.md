...
Flat, atmospheric depth. No drop shadows — depth in this world is conveyed by veils of light: translucency, soft blur used sparingly and purposefully (not decorative glassmorphism), and layered pacing during choreographed sequences. If an element needs to feel closer, it gets *clearer*, not shadowed.
